...
export class HumanUserService {
    ...
    /**
     * requests frontend
     * By passing in the appropriate options, you can search for available inventory in the system. This call is not further specified. Each IDS Metadata Broker can design its Frontend independently.
     * @returns string The Web UI as an HTML document. Might require a further login.
     * @throws ApiError
     */
    public  requestFrontend(): CancelablePromise<string> {
        return __request(this.OpenAPI, {
            method: 'GET',
            url: '/browse',
        });
